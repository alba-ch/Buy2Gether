...
import com.pis.buy2gether.databinding.InformaticaTabFragmentBinding;
import org.jetbrains.annotations.NotNull;

import java.util.ArrayList;

public class InformaticaTabFragment extends Fragment {
    InformaticaTabFragmentBinding binding;
    ...
    public View onCreateView(@NonNull @NotNull LayoutInflater inflater, @Nullable @org.jetbrains.annotations.Nullable ViewGroup container, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        //return root;
        binding = InformaticaTabFragmentBinding.inflate(inflater, container, false);
